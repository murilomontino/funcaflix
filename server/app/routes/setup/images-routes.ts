...
import {
	makeImageOutGenericComposer,
	makeStreamOutImageComposer,
} from '@/composers/images-composers'
...
Images.get(PathImages.GET_IMAGE, adaptFileRoute(makeImageOutGenericComposer()))

Images.get(PathImages.GET_QRCODE_IMAGE, async (req, res) => {
