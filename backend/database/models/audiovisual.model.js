...
let ModelProgramsTV = (_dec = (0, _sequelizeTypescript.Table)({
  ...
  constructor(...args) {
    ...
    _initializerDefineProperty(this, "subCategory", _descriptor5, this);

    _initializerDefineProperty(this, "publishedAt", _descriptor6, this);

    _initializerDefineProperty(this, "description", _descriptor7, this);

    _initializerDefineProperty(this, "thumbnail", _descriptor8, this);

    _initializerDefineProperty(this, "title", _descriptor9, this);

    _initializerDefineProperty(this, "tags", _descriptor10, this);

    _initializerDefineProperty(this, "genres", _descriptor11, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "subCategory", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "publishedAt", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor8 = _applyDecoratedDescriptor(_class2.prototype, "thumbnail", [_dec9], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor10 = _applyDecoratedDescriptor(_class2.prototype, "tags", [_dec11], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
}), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "genres", [_dec12], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
