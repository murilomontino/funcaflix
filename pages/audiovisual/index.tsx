...
const AudioVisual = ({ staticNewestVideos, staticPlaylist }) => {
	return (
		<AudioVisualScreen
			newestItems={staticNewestVideos}
...
export const getStaticProps: GetStaticProps = async (context) => {
	...
	const promisePlaylistAndItemsOrErr =
		await findAllPlaylistAndItemsUseCase.execute({
			category: ['1'],
			subCategory: ['162', '161', '11', '12', '13', '42'],
		})
	...
	const playlistAndItems =
		playlistAndItemsOrErr.isLeft() && playlistAndItemsOrErr.extract()
