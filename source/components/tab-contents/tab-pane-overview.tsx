...
const TabPaneOverview = ({ name, email, phone, city, hashtags, segment, uf, about, acting }: OverviewProps) => {
                    ...
                    <Col lg={12}>
                        ...
                        <div className="table-responsive" >
                            <Table className="table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <th className="ps-0" scope="row">Nome Perfil:</th>
                                        <td className="text-muted">{name}</td>
                                    </tr>
                                    <tr>
                                        <th className="ps-0" scope="row">Telefone Público:</th>
                                        <td className="text-muted">{phone}</td>
                                    </tr>
                                    <tr>
                                        <th className="ps-0" scope="row">Email Público:</th>
                                        <td className="text-muted">{email}</td>
                                    </tr>
                                    <tr>
                                        <th className="ps-0" scope="row">Cidade:</th>
                                        <td className="text-muted">{city}, {uf}</td>

                                    </tr>
                                    <tr>
                                        <th className="ps-0" scope="row">Segmento:</th>
                                        <td className="text-muted">{segment}</td>
                                    </tr>

                                    <tr>
                                        <th className="ps-0" scope="row">Atuação:</th>
