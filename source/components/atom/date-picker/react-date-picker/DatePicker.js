		...
		[
			...
			},
			{
				...
				value: function handleOutsideActionListeners(shouldListen) {
					...
					var isOpen = this.state.isOpen
					var shouldListenWithFallback =
						typeof shouldListen !== 'undefined' ? shouldListen : isOpen
					var fnName = shouldListenWithFallback
						? 'addEventListener'
						: 'removeEventListener'
				...
				value: function renderInputs() {
					...
					return /*#__PURE__*/ _react['default'].createElement(
						...
						/*#__PURE__*/ _react['default'].createElement(
							_DateInput['default'],
							_extends({}, ariaLabelProps, placeholderProps, {
						...
						/*#__PURE__*/ _react['default'].createElement(
							'div',
							{
								...
								className: (0, _mergeClassNames['default'])(
									className,
									''.concat(className, '--').concat(isOpen ? 'open' : 'closed')
								),
								style: isOpen ? undefined : {},
							},
							/*#__PURE__*/ _react['default'].createElement(
								_reactCalendar['default'],
								_extends(
									{
			...
			},
			{
				...
				value: function render() {
					...
					var onChange = eventProps.onChange,
						eventPropsWithoutOnChange = _objectWithoutProperties(
							eventProps,
							_excluded2
						)
...
var CalendarIcon = /*#__PURE__*/ _react['default'].createElement(
	'svg',
	_extends({}, iconProps, {
		className: ''
			.concat(baseClassName, '__calendar-button__icon ')
			.concat(baseClassName, '__button__icon'),
	}),
...
var ClearIcon = /*#__PURE__*/ _react['default'].createElement(
	'svg',
	_extends({}, iconProps, {
		className: ''
			.concat(baseClassName, '__clear-button__icon ')
			.concat(baseClassName, '__button__icon'),
	}),
	/*#__PURE__*/ _react['default'].createElement('line', {
		x1: '4',
...
DatePicker.propTypes = {
	...
	value: _propTypes['default'].oneOfType([
		isValue,
		_propTypes['default'].arrayOf(isValue),
	]),
