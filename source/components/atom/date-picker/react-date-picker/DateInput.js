	...
	return placeholder.split(pattern).reduce(function (arr, element, index) {
		...
		if (currentMatch) {
			var renderFunction =
				...
				elementFunctions[
					Object.keys(elementFunctions).find(function (elementFunction) {
	...
	function DateInput() {
		...
		_defineProperty(
			...
			function () {
				...
				var formElements = [
					_this.dayInput.current,
					_this.monthInput.current,
					_this.yearInput.current,
				].filter(Boolean)
				var values = {}
		...
		_defineProperty(
			...
			function (currentMatch, index) {
				...
				var showLeadingZerosFromFormat =
			...
			},
			{
				...
				get: function get() {
					...
					function formatDatePiece(name, dateToFormat) {
						return (0, _dateFormatter.getFormatter)(
							_defineProperty(
								{
									useGrouping: false,
								},
				...
				value: function getDerivedStateFromProps(nextProps, prevState) {
					...
					if (
						...
						if (nextValue) {
							...
							nextState.month = (0, _dateUtils.getMonthHuman)(
								nextValue
							).toString()
