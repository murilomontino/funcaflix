...
var isIEOrEdgeLegacy =
	typeof window !== 'undefined' &&
	/(MSIE|Trident\/|Edge\/)/.test(window.navigator.userAgent)
var isFirefox =
	typeof window !== 'undefined' && /Firefox/.test(window.navigator.userAgent)
	...
	return [
		...
		/*#__PURE__*/ _react['default'].createElement('input', {
			...
			className: (0, _mergeClassNames['default'])(
				...
				''.concat(className, '__').concat(nameForClass || name),
				hasLeadingZero && ''.concat(className, '__input--hasLeadingZero')
			),
			'data-input': 'true',
			disabled: disabled,
			inputMode: 'numeric',
			...
			ref: (0, _mergeRefs['default'])(
				_updateInputWidth['default'],
				updateInputWidthOnFontLoad,
				inputRef
			),
			required: required,
			step: step,
