...
import { CreateReadStreamUseCase } from '@/domain/usecases'

import { GetImageGenericUseCase } from './get-image-generic'

const makeSut = () => {
	const sut = new GetImageGenericUseCase(new CreateReadStreamUseCase())
	return {
		sut,
	}
}
...
describe('Unit Test Get Image Generic', () => {
	...
	it('should return a stream', async () => {
		...
		const stream = await sut.execute({
			image: '1a73ea1f-e06b-46f7-b277-72371e95e875.capa.webp',
		})
