      ...
      <div className='w-80 '>
        <div className='d-flex row justify-content-between m-2'>
          <div className="d-flex row flex-wrap">
            <ItemNavBar title="Política e Privacidade" link="/politica-de-privacidade" fontVariant="proportional-nums" />
            ...
            <ItemNavBar title="Governo do Estado de Sergipe" link={LINK_GOVERNO} fontVariant="proportional-nums" />
          </div>
          <div className="d-flex row flex-wrap">
