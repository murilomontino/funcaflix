                            ...
                            <div>
                                <div className="d-flex">
                                    ...
                                    <div className="flex-shrink-0">
                                        <a href="/pages-profile-settings" className="btn btn-info"><i
                                                ...
                                                <Card>
                                                    <CardBody>
                                                        ...
                                                        <div className="d-flex flex-wrap gap-2 fs-15">
                                                            <a href="#"
                                                                className="badge badge-soft-primary">Photoshop</a>
                                                            <a href="#"
                                                                className="badge badge-soft-primary">illustrator</a>
                                                            <a href="#"
                                                                className="badge badge-soft-primary">HTML</a>
                                                            <a href="#"
                                                                className="badge badge-soft-primary">CSS</a>
                                                            <a href="#"
                                                                className="badge badge-soft-primary">Javascript</a>
                                                            <a href="#"
                                                                className="badge badge-soft-primary">Php</a>
                                                            <a href="#"
                                                                className="badge badge-soft-primary">Python</a>
                                                        </div>
                                                    </CardBody>
                                                </Card>
                                                                            ...
                                                                            <div className="accordion accordion-flush" id="todayExample">
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header" id="headingTwo">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapseTwo">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="headingThree">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                                                    <img src={avatar5}
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="headingFour">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapseFour" >
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0 avatar-xs">
                                                                                                    <div
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="headingFive">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapseFive" >
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                                                    <img src={avatar7}
                                                                        ...
                                                                        <div className="profile-timeline">
                                                                            <div className="accordion accordion-flush"
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="heading6">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapse6">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                                                    <img src={avatar3}
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="heading10">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapse10">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                        ...
                                                                        <div className="profile-timeline">
                                                                            <div className="accordion accordion-flush"
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="heading11">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapse11" >
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0 avatar-xs">
                                                                                                    <div
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="heading14">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapse14">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0 avatar-xs">
                                                                                                    <div
                                                                                ...
                                                                                <div className="accordion-item border-0">
                                                                                    <div className="accordion-header"
                                                                                        id="heading15">
                                                                                        <a href="#" className="accordion-button p-2 shadow-none" id="collapse15">
                                                                                            <div className="d-flex">
                                                                                                <div
                                                                                                    className="flex-shrink-0">
                                                                                                    <img src={avatar7}
                                                                            ...
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    ...
                                                                                    <h5 className="fs-14 text-truncate mb-1">
                                                                                        <a href="#" className="text-dark">Client - John</a></h5>
                                                                                    <p className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                        ...
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    ...
                                                                                    <h5
                                                                                        className="fs-14 text-truncate mb-1">
                                                                                        <a href="#" className="text-dark">Brand logo Design</a></h5>
                                                                                    <p className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                        ...
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div className="flex-grow-1 text-muted overflow-hidden">
                                                                                    <h5 className="fs-14 text-truncate mb-1">
                                                                                        <a href="#" className="text-dark">Chat App</a></h5>
                                                                                    <p
                                                                                        className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                                            className="fw-semibold text-dark">1
                                                        ...
                                                        <Col xxl={3} sm={6} key={key}>
                                                            <Card className={`profile-project-card shadow-none profile-project-${item.cardBorderColor}`}>
                                                                <CardBody className="p-4">
                                                                    <div className="d-flex">
                                                                        <div className="flex-grow-1 text-muted overflow-hidden">
                                                                            <h5 className="fs-14 text-truncate"><a href="#"
                                                                                className="text-dark">{item.title}</a>
                                                                            </h5>
                                                                            ...
                                                                            <td>
                                                                                <div className="d-flex align-items-center">
                                                                                    ...
                                                                                    <div className="ms-3 flex-grow-1">
                                                                                        <h6 className="fs-15 mb-0"><a href="#" className="link-dark">{item.fileName}</a>
                                                                                        </h6>
                                                                                    </div>
                                                                                </div>
                                                                            </td>
